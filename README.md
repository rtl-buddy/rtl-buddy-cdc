...
- [x] CDC-001 through CDC-006, CDC-008, CDC-009 (skipping CDC-010, drafted in [`docs/proposals/clock-network-glitch.md`](docs/proposals/clock-network-glitch.md)), CDC-011 (unconstrained primary inputs), RDC-001 through RDC-005 (the full reset-domain rule family — #107 / #114; RDC-001 is the reset-crossing rule formerly known as CDC-007)
